...
1. Просмотр словаря в виде anki-карточек
2. Добавление новых слов в словарь пользователем
3. Возможность добавления пройденных уроков
4. Просмотр списка пройденных уроков
4. Просмотр статистики ко категориям
